...
<div class="row">
    <div class="col-md-3 col-sm-12">
        ...
        <select name="tipo_endereco" id="tipo_endereco" class="form-control">
            ...
            @foreach ($tipos_endereco as $tipo)
                <option value="{{ $tipo->id }}" {{$item->tipo_id == $tipo->id ? " selected" : ''}}>{{ $tipo->tipo }}</option>
            @endforeach
        </select>
    ...
    <div class="col-md-2 col-sm-12">
        ...
        <div class="input-group mb-3">
            ...
            <input name="cep" id="cep" type="text" class="form-control" placeholder="CEP" aria-label="cep"
                aria-describedby="btn-cep" disabled value="{{$item->cep}}">
    ...
    <div class="col-md-2 col-sm-12">
        ...
        <select name="estado" id="estado" class="form-control">
            ...
            @foreach ($estados as $estado)
                <option value="{{ $estado->id }}" {{ $estado->id == $item->cidade->state_id ? ' selected' : '' }}>
                    {{ $estado->abbreviation }}
                </option>
            @endforeach
    ...
    <div class="col-md-2 col-sm-12">
        ...
        <select name="cidade" id="cidade" class="form-control">
            ...
            @foreach ($item->cidade->estado->cidades as $cidade)
                <option value="{{ $cidade->id }}" {{$item->cidade_id == $cidade->id ? " selected" : ""}}>{{ $cidade->name }}</option>
            @endforeach
...
<div class="row pt-2 mr-2" id="endereco" style="display:none">
    ...
    <div class="col-md-4 col-sm-12">
        ...
        <input type="text" name="rua" id="rua" class="form-control" value="{{$item->logradouro}}">
    ...
    <div class="col-md-3 col-sm-12">
        ...
        <input type="text" name="bairro" id="bairro" class="form-control" value="{{$item->bairro}}">
    ...
    <div class="col-md-2 col-sm-12">
        ...
        <input type="text" name="complemento" id="complemento" class="form-control" value="{{$item->complemento}}">
